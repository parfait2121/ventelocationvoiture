     ...
     <section class="navbar custom-navbar navbar-fixed-top" role="navigation">
          <div class="container">
               ...
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand">e-VAIKA.R</a>
               </div>
                    ...
                    <ul class="nav navbar-nav navbar-nav-first">
                         ...
                         <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                   <li class="<?php echo isActive($vue, "blog-post") ?>" ><a href="<?php echo site_url_spx("welcome/location") ?>">Location</a></li>
                                   <li class="<?php echo isActive($vue, "testimonials") ?>" ><a href="<?php echo site_url_spx("welcome/ventes") ?>">Vente</a></li>
                              </ul>
                         </li>
                         <li class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                   <li class="" ><a href="<?php echo site_url_spx("welcome/login") ?>">Se connecter</a></li>
                                   <li class="" ><a href="<?php echo site_url_spx("welcome/register") ?>">S'inscrire</a></li>
                              </ul>
                         </li>
                         <li class="<?php echo isActive($vue, "profile") ?>"><a href="<?php echo site_url_spx("welcome/profile") ?>">Profile</a></li>
                         <li class="<?php echo isActive($vue, "checkout") ?>"><a href="<?php echo site_url_spx("welcome/checkout") ?>">Paiement</a></li>
                         <li class="<?php echo isActive($vue, "contact") ?>"><a href="<?php echo site_url_spx("welcome/contact") ?>">Nous contacter</a></li>
                         <li class="<?php echo isActive($vue, "about-us") ?>"><a href="<?php echo site_url_spx("welcome/about") ?>">A propos</a></li>
                    </ul>
               </div>
